...
export class postMediaNullable1657974968099 implements MigrationInterface {
    name = 'postMediaNullable1657974968099'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "posts" ALTER COLUMN "media" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "posts" ALTER COLUMN "media" SET NOT NULL`);
